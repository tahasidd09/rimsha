      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            I am a Software Engineer and Frontend Developer with a passion for creating interactive and responsive web applications.
          </p>
          <div>
            <Link
              href="/#contact"
        ...
        >
          <div className="rounded-full bg-[#aeccdb] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            <Image
              src="/images/dp-image.jpg"
              alt="hero image"
